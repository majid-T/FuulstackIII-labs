...
let localConnectionString = 'mongodb://localhost:27017/?readPreference=primary&appname=MongoDB%20Compass%20Community&ssl=false';
...
const insertData = ()=>{
    ...
    .then((res)=>{
        console.log(`Data inserted msg: ${res}`);
    })
    .catch((err)=>{
